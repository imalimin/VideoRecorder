...
import com.lmy.video.gl.view.texture.GLSurfaceTextureProducerView;
import com.lmy.video.gl.view.texture.GLViewRenderer;
import com.lmy.video.gl.view.texture.gles.EglContextWrapper;
import com.lmy.video.gl.view.texture.gles.GLThread;
...
public abstract class OffScreenCanvas implements GLViewRenderer {
    ...
    public void onSurfaceCreated() {
        Log.d("OffScreenCanvas", "onSurfaceCreated: ");
        mCanvas = new CanvasGL();
    }

    @Override
    public void onSurfaceChanged(int width, int height) {
        Log.d("OffScreenCanvas", "onSurfaceChanged: ");
