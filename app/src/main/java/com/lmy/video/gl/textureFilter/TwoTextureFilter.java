...
package com.lmy.video.gl.textureFilter;
...
import com.lmy.video.gl.canvas.TextureMatrixTransformer;
...
public abstract class TwoTextureFilter extends BasicTextureFilter {
    ...
    protected final float[] mTempTextureMatrix = new float[CanvasGL.BitmapMatrix.MATRIX_SIZE];
